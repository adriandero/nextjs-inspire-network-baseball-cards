...
interface ResponsivePDFLayoutProps {
  title: string;
  isLoading: boolean;
  error?: string | null;
  ...
  className?: string;
  // Optional responsive font sizing props
  baseFontSize?: string;
  headingFontSize?: string;
}

export const ResponsivePDFLayout = forwardRef<HTMLDivElement, ResponsivePDFLayoutProps>(
  ({
     title,
     isLoading,
     error,
    ...
    const hasProfiles = completeProfileTables.length > 0 &&
...
ResponsivePDFLayout.displayName = "ResponsivePDFLayout";